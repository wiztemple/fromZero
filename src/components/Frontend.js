               ...
               a newbie with the current knowledge I have now, <br /> these are the resources I would use</p>
                <div className="list-decimal text-loon dark:text-purple-300 shadow-sm my-10">
                  {resources.map(resource => (
                    <a href={resource.link} className="flex md:text-base text-sm items-center space-x-6 border-b border-gray-200 dark:border-gray-800 py-3 md:px-10 px-5 hover:bg-gray-50 dark:hover:bg-gray-900">
